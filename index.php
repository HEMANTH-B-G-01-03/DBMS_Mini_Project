...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <footer class="bg-info-subtle py-5" style="background-image: url('flight3.jpg'); /* Replace with the correct path to your footer background image */
            background-size: cover;
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 ml-auto text-center mb-5 mb-lg-0">
                <i class="fas fa-phone fa-3x mb-3 text-large"></i>
                <div><?php echo $_SESSION['setting_contact'] ?></div>
            </div>
            <div class="col-lg-4 mr-auto text-center">
                <i class="fas fa-envelope fa-3x mb-3 text-large"></i>
